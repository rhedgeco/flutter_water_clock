...
import 'digital_water_clock.dart';
...
void main() {
  ...
  // own clock widget. (Look in digital_water_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) => DigitalWaterClock(model)));
}
